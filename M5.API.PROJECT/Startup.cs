...
using M5.API.PROJECT.Framework.Infrastructure.Repositories;
using MediatR;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IProjectQuery, ProjectQuery>()
                    .AddScoped<IProjectRepository, ProjectRepository>(serviceProvider =>
                    {
                        return new ProjectRepository(serviceProvider.GetRequiredService<EFContext>());
                    });
